...
class ProtocolParamsParserTest {
    ...
    @Test
    public void testOk2() {
        // Test parsing protocol params with list format (no constructor wrapper)
        ...
        var expected = ProtocolParams.builder()
                .registryNodePolicyId("f1f838a525637791ca06d1fd415358a27ba829024ee0b90af5e32f14")
                .programmableLogicBaseScriptHash("fca77bcce1e5e73c97a0bfa8c90f7cd2faff6fd6ed5b6fec1c04eefa")
                .build();
